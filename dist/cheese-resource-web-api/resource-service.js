    ...
    function ResourceService($injector, $resource) {
        ...
        this.resource = $resource(this.config.apiBasePath + 'api/:resourceName/:id', { id: '@id' }, {
            update: {
                ...
                interceptor: {
                    ...
                    responseError: function (httpResponse) {
                        return _this.onUpdateItemError(httpResponse);
                    }
                }
            },
            query: {
                ...
                interceptor: {
                    ...
                    responseError: function (httpResponse) {
                        return _this.onGetListError(httpResponse);
                    }
                }
            },
            get: {
                ...
                interceptor: {
                    response: function (httpResponse) {
                        return _this.onGetItemSuccess(httpResponse);
                    },
                    responseError: function (httpResponse) {
                        return _this.onGetItemError(httpResponse);
                    }
                }
            },
            create: {
            ...
            delete: {
                ...
                interceptor: {
                    response: function (httpResponse) {
                        return _this.onDeleteItemSuccess(httpResponse);
                    },
                    responseError: function (httpResponse) {
                        return _this.onDeleteItemError(httpResponse);
                    }
                }
            }
        });
